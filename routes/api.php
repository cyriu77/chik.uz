...
//transactions
Route::middleware('auth:sanctum')->post('/cancel-purchase-post/{postId}', [PostController::class, 'cancelPurchasePost']);
Route::middleware('auth:sanctum')->post('/purchase-post/{postId}', [PostController::class, 'purchasePost']);

// Messages
Route::middleware('auth:sanctum')->post('/posts/{id}/messages', [MessageController::class, 'store']);
Route::middleware('auth:sanctum')->get('/posts/{post:slug}/messages', [MessageController::class, 'getMessages']);
...
Route::get('posts/category/{category}', [PostController::class, 'indexByCategory']);
